package com.fengxuechao.order.service.center;


import com.fengxuechao.order.pojo.Orders;
import com.fengxuechao.order.pojo.vo.OrderStatusCountsVO;
...
public interface MyOrdersService {
    ...
    public ResultBean checkUserOrder(@RequestParam("userId") String userId,
                                          @RequestParam("orderId") String orderId);
