package com.fengxuechao.rabbit.producer.task;

import java.util.List;

import com.fengxuechao.rabbit.producer.broker.RabbitBroker;
...
@Component
@ElasticJobConfig(
		name= "com.fengxuechao.rabbit.producer.task.RetryMessageDataflowJob",
		cron= "0/10 * * * * ?",
