package com.fengxuechao.rabbit.producer.config.database;
...
public class RabbitProducerMyBatisConfiguration {
	...
	public SqlSessionFactory rabbitProducerSqlSessionFactory(DataSource rabbitProducerDataSource) {
		...
		try {
			bean.setMapperLocations(resolver.getResources("classpath:com/fengxuechao/rabbit/producer/mapping/*.xml"));
