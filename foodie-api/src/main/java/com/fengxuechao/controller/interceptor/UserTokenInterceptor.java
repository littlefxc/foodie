package com.fengxuechao.controller.interceptor;
...
//                System.out.println("请登录...");
                returnErrorResponse(response, ResultBean.errorMsg("请登录..."));
                return false;
            } else {
                if (!uniqueToken.equals(userToken)) {
//                    System.out.println("账号在异地登录...");
                    returnErrorResponse(response, ResultBean.errorMsg("账号在异地登录..."));
                    return false;
                }
            }
        } else {
