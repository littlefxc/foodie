package com.fengxuechao.jvm.objectpool.commonspool;
...
//    LOGGER.info("destroyObject..state = {}", p.getState());
        System.out.println("destroyObject..state = " + p.getState());
    }

    @Override
    public boolean validateObject(PooledObject<Money> p) {
//    LOGGER.info("validateObject..state = {}", p.getState());
        System.out.println("validateObject..state = " + p.getState());
        return true;
    }
