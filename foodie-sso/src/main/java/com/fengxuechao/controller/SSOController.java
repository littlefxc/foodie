...
//        return "login";
    ...
    @ResponseBody
    public ResultBean verifyTmpTicket(String tmpTicket,
                        HttpServletRequest request,
                        HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isBlank(tmpTicketValue)) {
            return ResultBean.errorUserTicket("用户票据异常");
        }
        ...
        // 验证成功，返回OK，携带用户会话
        return ResultBean.ok(JsonUtils.jsonToPojo(userRedis, UsersVO.class));
    }
