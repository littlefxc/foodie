...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://shop.z.mukewang.com:9090");
        config.addAllowedOrigin("http://center.z.mukewang.com:9090");
        config.addAllowedOrigin("http://shop.z.mukewang.com");
        config.addAllowedOrigin("http://center.z.mukewang.com");
        config.addAllowedOrigin("http://www.mtv.com");
        config.addAllowedOrigin("http://www.mtv.com:9090");
        config.addAllowedOrigin("http://www.music.com");
        config.addAllowedOrigin("http://www.music.com:9090");
